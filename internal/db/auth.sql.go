...
SELECT u.id, u.username, u.email, u.created_at, u.role, u.default_node_visibility, u.timezone, u.profile_image_path, ai.secret AS password_hash, ai.id AS identity_id
FROM users u
