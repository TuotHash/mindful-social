...
SELECT n.id, n.type, n.title, n.body, n.source_url, n.created_by, n.created_at, n.updated_at, n.search_tsv, n.slug, n.visibility, n.visibility_list_id, n.edit_policy, n.link_policy FROM nodes n
